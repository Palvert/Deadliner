...
class Application(tk.Frame):
    ...
    def createWidgets(self):
        ...
        # SET WIDGETS
        # Timer 1
        frame = ttk.Frame(self)#, background=GRAY)
        ent_timer = ttk.Entry(frame, bg=GRAY, fg=BLACK, width=20, cursor="xterm", font=(font_1 + font_1_size), relief="solid")
        ...
        date_ent = ttk.DateEntry(frame, mindate=datetime.date.today(), 
                                date_pattern="dd.mm.yyyy", font=(font_1 + font_1_size))
        lbl_time_left = ttk.Label(frame, text="0000 | 00:00", bg=GRAY, fg=BLACK, font=(font_1 + font_1_size + "bold")) 
